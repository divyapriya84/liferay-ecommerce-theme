...
package com.rivetlogic.ecommerce.service.util;
...
public class PortletPropsUtil {
    ...
    private PortletPropsUtil() {
        _configuration = ConfigurationFactoryUtil.getConfiguration(getClass().getClassLoader(), "portlet");
    }

    private static PortletPropsUtil _instance = new PortletPropsUtil();
