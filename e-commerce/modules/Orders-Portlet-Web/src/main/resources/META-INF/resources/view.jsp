...
<liferay-ui:search-container total="<%= ShoppingOrderLocalServiceUtil.countByGroupId(groupId) %>" emptyResultsMessage="no-orders-found" orderByType="<%= ordering %>">
	...
	<liferay-ui:search-container-row className="com.rivetlogic.ecommerce.model.ShoppingOrder" modelVar="order">
		...
		<liferay-ui:search-container-column-jsp  name="order-actions" path="/actions.jsp" />
