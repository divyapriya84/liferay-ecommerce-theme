package com.rivetlogic.ecommerce.shoppingcart.portlet;
...
import com.rivetlogic.ecommerce.shoppingcart.configuration.ShoppingCartConfiguration;


@Component(
	configurationPid =
	"com.rivetlogic.ecommerce.shoppingcart.configuration.ShoppingCartConfiguration",
	immediate = true,
	property = {
...
@Override
	public void doView(RenderRequest request, RenderResponse response)
		...
		request.setAttribute(ShoppingCartConfiguration.class.getName(), shoppingCartConfiguration);
		...
		if (themeDisplay.isSignedIn()) {
			try {
				...
				if (null != activeShoppingOrder) {
					...
					List<ShoppingCartItem> cartItems = ShoppingCartItemUtil.getCartItems(themeDisplay, orderItemsList);
	...
	private String doCheckout(ActionRequest request, ActionResponse response, boolean isPaypal) throws Exception{
		...
		List<ShoppingCartItem> shoppingCartItems = 
                (themeDisplay.isSignedIn() ? ShoppingCartItemUtil.getCartItems(themeDisplay, orderItemsList) : ShoppingCartItemUtil.getCartItemsByProductId(orderItemsIdsList, themeDisplay));
	...
	protected void activate(Map<Object, Object> properties) {
		shoppingCartConfiguration = Configurable.createConfigurable(
	        		ShoppingCartConfiguration.class, properties);
	}

	private volatile ShoppingCartConfiguration shoppingCartConfiguration;
